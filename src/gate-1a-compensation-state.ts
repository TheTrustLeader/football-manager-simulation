...
const CONFIG_PATH = "ENGINE_CONFIG.squadGeneration.identityParity.compensationAdjustments";
...
export function readParityCompensationState() {
  const adjustments = ENGINE_CONFIG.squadGeneration.identityParity.compensationAdjustments;
